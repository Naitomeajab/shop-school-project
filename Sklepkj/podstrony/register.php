...
<body>
    ...
    <div class="tree-container"><i class="bi bi-folder-fill"></i> <a href="../index.php">Strona głowna</a>/<span>rejestracja</span></div>
    <div style="width: 600px;margin: auto;" >
        <!-- Standardowy formularz, chciałem zrobić jeszcze wpis na "powtórz/potwierdź hasło", ale pusta lampka wina oraz energetyk poza zasięgiem ręki nie jest dobrym motywatorem -->
        <form action="../processes/registerprocess.php" method="post">
            <h2>Formularz rejestracji</h2>
            <div class="login-container">
                <i class="bi bi-person-fill login-icon"></i>
                <input type="text" name="nazwa_uzytkownika" placeholder="Nazwa użytkownika (od 8 do 16 znaków, bez znaków specialnych)">
            </div>
            <div class="login-container">
                <i class="bi bi-envelope-fill login-icon"></i>
                <input type="email" name="mail" placeholder="E-mail">
            </div>
            <div class="login-container">
                <i class="bi bi-key-fill login-icon"></i>
                <input type="password" name="passw" placeholder="Hasło (od 8 do 64 znaków, bez znaków specialnych)">
            </div>
